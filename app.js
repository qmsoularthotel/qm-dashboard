  ...
  function renderCameriera(name,rooms){
    ...
    let h=`<div style="flex:1;min-width:0;">
      ...
      <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;flex-wrap:wrap;">
        ...
        <span style="font-size:11px;font-weight:700;padding:4px 10px;border-radius:7px;background:var(--surface);border:1px solid var(--border);color:var(--text-dim);" title="Carico pesato: partenza=${HK_WEIGHT_PARTENZA} (${HK_WEIGHT_PARTENZA_HEAVY} per Art 1,2,3,8,9,13), fermata=${HK_WEIGHT_FERMATA} (${HK_WEIGHT_FERMATA_HEAVY} per Art 1,2,3,8,9,13)">⚖ Carico pesato: <strong style="color:var(--text);">${caricoTxt}</strong></span>
      </div>`;
    if(nPart){
