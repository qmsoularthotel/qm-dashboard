...
async function revExpGenerateReply(p,gi){
  ...
  const prompt=`Sei Paolo P., Quality Manager del ${hotelName} a Napoli, un hotel 4 stelle con storia e carattere unico.\n\nDevi rispondere a questa recensione ${platform} in ${lang}.\n\nDATI RECENSIONE:\n- Punteggio: ${r._score}/10\n- Titolo: ${r['review_title']||'—'}\n- Testo: ${r['review_text']||'—'}\n\nREGOLE OBBLIGATORIE — rispettale tutte senza eccezioni:\n1. APERTURA FISSA: inizia SEMPRE con "${italian?'Gentile ospite,':'Dear Guest,'}" — mai usare il nome dell'ospite (policy Expedia)\n2. PUNTEGGIO: cita il punteggio ricevuto e ringrazia per la valutazione\n3. PUNTI POSITIVI: richiama aspetti specifici menzionati nella recensione (non generici)\n4. CRITICHE: affronta ogni critica con spiegazione contestuale e azione correttiva concreta — non solo scuse\n5. CARATTERE DELLA STRUTTURA: quando pertinente, valorizza il carattere storico/unico della struttura\n6. CHIUSURA: invita sempre l'ospite a tornare per un soggiorno ancora più piacevole\n7. FIRMA FINALE obbligatoria: "${firma}"\n8. ${toneDesc}\n9. Non ripetere le stesse parole usate dall'ospite\n10. Rispondi SOLO con il testo della risposta, senza preamboli né commenti`;
  try{
