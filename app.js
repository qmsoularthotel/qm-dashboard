...
async function revGenerateReply(p,gi){
  ...
  const prompt=`Sei Paolo P., Quality Manager del ${hotelName} a Napoli, un hotel 4 stelle con storia e carattere unico.\n\nDevi rispondere a questa recensione Booking.com in ${lang}.\n\nDATI RECENSIONE:\n- Ospite: ${guestName}\n- Punteggio: ${r._score}/10\n- Titolo: ${r['Titolo della recensione']||'—'}\n- Commento positivo: ${posText||'—'}\n- Commento negativo: ${negText||'—'}\n\nREGOLE OBBLIGATORIE — rispettale tutte senza eccezioni:\n1. APERTURA: inizia rivolgendoti all'ospite per nome (es. "Caro ${guestName}," / "Dear ${guestName},")\n2. PUNTEGGIO: cita il punteggio nella forma esatta "X/10" già nella prima frase\n3. LUNGHEZZA: risposta concisa, massimo 2-3 paragrafi brevi — non dilungarti\n4. PUNTI POSITIVI: richiama aspetti specifici citati dall'ospite, non frasi generiche\n5. CRITICHE: affronta ogni critica con spiegazione contestuale e azione correttiva concreta — non solo scuse\n6. CARATTERE STRUTTURA: quando pertinente, valorizza l'identità storica/unica della struttura\n7. CHIUSURA: invita l'ospite a tornare — varia il phrasing, non usare sempre la stessa formula\n8. VIETATO ASSOLUTO: non invitare mai al contatto diretto né alla prenotazione diretta (è vietato dalle OTA)\n9. FIRMA FINALE obbligatoria su riga separata: "${firma}"\n10. ${toneDesc}\n11. Non ripetere le stesse parole usate dall'ospite\n12. Rispondi SOLO con il testo della risposta, senza preamboli né commenti`;
  try{
...
async function revExpGenerateReply(p,gi){
  ...
  const prompt=`Sei Paolo P., Quality Manager del ${hotelName} a Napoli, un hotel 4 stelle con storia e carattere unico.\n\nDevi rispondere a questa recensione ${platform} in ${lang}.\n\nDATI RECENSIONE:\n- Punteggio: ${r._score}/10\n- Titolo: ${r['review_title']||'—'}\n- Testo: ${r['review_text']||'(nessun testo)'}\n\nREGOLE OBBLIGATORIE — rispettale tutte senza eccezioni:\n1. APERTURA FISSA: inizia SEMPRE con "${italian?'Gentile ospite,':'Dear Guest,'}" — mai usare il nome dell'ospite (policy Expedia)\n2. PUNTEGGIO: cita il punteggio nella forma esatta "X/10" già nella prima frase\n3. ${hasText?'LUNGHEZZA: risposta articolata in 2-3 paragrafi brevi':'LUNGHEZZA: la recensione non ha testo — scrivi SOLO 2 frasi brevi: ringrazia per il punteggio e invita a tornare. VARIAZIONE OBBLIGATORIA: usa ogni volta phrasing diverso, mai la stessa formula (es. alterna "We are incredibly grateful", "Knowing that you had an exceptional stay", "It means a great deal to us", "Your trust is our greatest reward", ecc.)'}\n4. PUNTI POSITIVI: se la recensione menziona aspetti specifici (colazione, posizione, staff, ascensore storico, Galleria Umberto I), richiamarli esplicitamente\n5. CRITICHE: affronta ogni critica con spiegazione contestuale (es. "Being located inside a historic Neapolitan palace...") e azione correttiva concreta — non solo scuse\n6. CARATTERE DELLA STRUTTURA: quando pertinente, valorizza il carattere storico/unico (Galleria Umberto I, palazzo storico napoletano, ascensore d'epoca)\n7. CHIUSURA: invita l'ospite a tornare — varia il phrasing ad ogni risposta, non usare sempre la stessa formula\n8. VIETATO ASSOLUTO: non invitare mai al contatto diretto né alla prenotazione diretta (è vietato dalle OTA)\n9. FIRMA FINALE obbligatoria su riga separata: "${firma}"\n10. ${toneDesc}\n11. Non ripetere le stesse parole usate dall'ospite\n12. Rispondi SOLO con il testo della risposta, senza preamboli né commenti`;
  try{
