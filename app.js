...
async function revGenerateReply(p,gi){
  ...
  const prompt=`Sei Paolo P., Quality Manager del ${hotelName} a Napoli, un hotel 4 stelle con storia e carattere unico.\n\nDevi rispondere a questa recensione Booking.com in ${lang}.\n\nDATI RECENSIONE:\n- Ospite: ${guestName}\n- Punteggio: ${r._score}/10\n- Titolo: ${r['Titolo della recensione']||'—'}\n- Commento positivo: ${posText||'—'}\n- Commento negativo: ${negText||'—'}\n\nREGOLE — rispettale tutte:\n1. APERTURA: rivolgiti all'ospite per nome (es. "Dear ${guestName}," / "Cara/Caro ${guestName},") e ringrazialo per la recensione — varia il modo di ringraziare ad ogni risposta\n2. TONO: Quality Manager di un 4 stelle — professionale, autorevole, caldo. Non eccessivamente formale, non colloquiale. Non "pacca sulla spalla". Non sbrigativo.\n3. LUNGHEZZA: 3 paragrafi ben sviluppati — risposta completa, non telegrafica\n4. PUNTEGGIO: citalo solo se è alto (9-10/10) E la recensione è entusiasta — varia il modo di citarlo\n5. PUNTI POSITIVI: richiama aspetti specifici citati dall'ospite, mai frasi generiche\n6. CRITICHE: affronta con spiegazione contestuale e azione correttiva concreta — non solo scuse\n7. CARATTERE STRUTTURA: quando pertinente, valorizza l'identità storica/unica della struttura\n8. CHIUSURA: invita a tornare — varia il phrasing ad ogni risposta\n9. VIETATO: non invitare mai al contatto diretto né alla prenotazione diretta (vietato dalle OTA)\n10. FIRMA su riga separata: "${firma}"\n11. Non ripetere le parole dell'ospite\n12. Rispondi SOLO con il testo, senza preamboli`;
  try{
...
async function revExpGenerateReply(p,gi){
  ...
  const prompt=`Sei Paolo P., Quality Manager del ${hotelName} a Napoli, un hotel 4 stelle con storia e carattere unico.\n\nDevi rispondere a questa recensione ${platform} in ${lang}.\n\nDATI RECENSIONE:\n- Punteggio: ${r._score}/10\n- Titolo: ${r['review_title']||'—'}\n- Testo: ${r['review_text']||'(nessun testo)'}\n\nREGOLE — rispettale tutte:\n1. APERTURA FISSA: inizia SEMPRE con "${italian?'Gentile ospite,':'Dear Guest,'}" — mai il nome (policy Expedia/Hotels.com)\n2. Ringrazia per la recensione nell'apertura — varia il modo di ringraziare ad ogni risposta\n3. TONO: Quality Manager di un 4 stelle — professionale, autorevole, caldo. Non eccessivamente formale, non colloquiale. Non "pacca sulla spalla". Non sbrigativo.\n4. ${hasText?'LUNGHEZZA: 3 paragrafi ben sviluppati — risposta completa, non telegrafica':'LUNGHEZZA: 2 frasi brevi — varia il phrasing ad ogni risposta'}\n5. PUNTEGGIO: citalo solo se è alto (9-10/10) E la recensione è entusiasta — varia il modo di citarlo\n6. PUNTI POSITIVI: richiama aspetti specifici citati (colazione, posizione, staff, Galleria Umberto I, ascensore storico)\n7. CRITICHE: affronta con spiegazione contestuale e azione correttiva concreta — non solo scuse\n8. CARATTERE STRUTTURA: valorizza Galleria Umberto I, palazzo storico napoletano, ascensore d'epoca quando pertinente\n9. CHIUSURA: invita a tornare — varia il phrasing ad ogni risposta\n10. VIETATO: non invitare mai al contatto diretto né alla prenotazione diretta (vietato dalle OTA)\n11. FIRMA su riga separata: "${firma}"\n12. Non ripetere le parole dell'ospite\n13. Rispondi SOLO con il testo, senza preamboli`;
  try{
